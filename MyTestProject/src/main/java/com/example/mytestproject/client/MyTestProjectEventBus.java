...
import com.example.mytestproject.client.ui.header.HeaderPresenter;
import com.example.mytestproject.client.ui.navigation.NavigationPresenter;
...
public interface MyTestProjectEventBus extends IsEventBus {
  /**
